...
export type TipoPaso = 'inhalar' | 'exhalar' | 'mantener' | 'descanso' | 'activo' | 'preparacion' | 'alerta';
export type CategoriaEjercicio = 'respiratorio' | 'aparatos' | 'movilidad';
export type SeccionVista = 'plan' | 'biblioteca';
...
const PASOS_ACAPELLA: PasoGuiado[] = [
  ...
  { instruccion: 'Siéntese erguida, codos en la mesa, espalda recta.', duracion: 8, tipo: 'preparacion' },
  { instruccion: 'Oxígeno puesto. Deténgase si siente mareos.', duracion: 7, tipo: 'alerta' },
  // Ciclos 1–5
  { instruccion: 'Profundo por la nariz. Sin el dispositivo.', duracion: 4, tipo: 'inhalar' },
  { instruccion: 'Sostenga el aire.', duracion: 3, tipo: 'mantener' },
  { instruccion: 'Boquilla en la boca. Lento y constante. Sienta la vibración.', duracion: 7, tipo: 'exhalar' },
  { instruccion: 'Profundo por la nariz.', duracion: 4, tipo: 'inhalar' },
  { instruccion: 'Sostenga.', duracion: 3, tipo: 'mantener' },
  { instruccion: 'Lento y constante. Sin brusquedad.', duracion: 7, tipo: 'exhalar' },
  { instruccion: 'Profundo por la nariz.', duracion: 4, tipo: 'inhalar' },
  { instruccion: 'Sostenga.', duracion: 3, tipo: 'mantener' },
  { instruccion: 'Constante y suave por el Acapella.', duracion: 7, tipo: 'exhalar' },
  { instruccion: 'Profundo.', duracion: 4, tipo: 'inhalar' },
  { instruccion: 'Sostenga.', duracion: 3, tipo: 'mantener' },
  { instruccion: 'Suave y constante. Sienta la vibración.', duracion: 7, tipo: 'exhalar' },
  { instruccion: 'Profundo por la nariz.', duracion: 4, tipo: 'inhalar' },
  { instruccion: 'Sostenga.', duracion: 3, tipo: 'mantener' },
  { instruccion: 'Constante. Va muy bien.', duracion: 7, tipo: 'exhalar' },
  // Pausa
  { instruccion: 'Retire el dispositivo. Respire 2-3 veces con normalidad.', duracion: 12, tipo: 'descanso' },
  // Ciclos 6–10
  { instruccion: 'Profundo por la nariz.', duracion: 4, tipo: 'inhalar' },
  { instruccion: 'Sostenga.', duracion: 3, tipo: 'mantener' },
  { instruccion: 'Lento y constante por el Acapella.', duracion: 7, tipo: 'exhalar' },
  { instruccion: 'Profundo por la nariz.', duracion: 4, tipo: 'inhalar' },
  { instruccion: 'Sostenga.', duracion: 3, tipo: 'mantener' },
  { instruccion: 'Sienta la vibración en el pecho.', duracion: 7, tipo: 'exhalar' },
  { instruccion: 'Profundo.', duracion: 4, tipo: 'inhalar' },
  { instruccion: 'Sostenga.', duracion: 3, tipo: 'mantener' },
  { instruccion: 'Constante. Casi terminamos.', duracion: 7, tipo: 'exhalar' },
  { instruccion: 'Profundo por la nariz.', duracion: 4, tipo: 'inhalar' },
  { instruccion: 'Sostenga.', duracion: 3, tipo: 'mantener' },
  { instruccion: 'Suave y constante.', duracion: 7, tipo: 'exhalar' },
  { instruccion: 'Último ciclo. Profundo por la nariz.', duracion: 4, tipo: 'inhalar' },
  { instruccion: 'Sostenga el aire.', duracion: 3, tipo: 'mantener' },
  { instruccion: 'Último exhale. Constante y suave.', duracion: 7, tipo: 'exhalar' },
  // Descanso + tos dirigida
  { instruccion: 'Muy bien. Respire normalmente unos segundos.', duracion: 10, tipo: 'descanso' },
  { instruccion: 'Tos dirigida. Profundo por la nariz.', duracion: 4, tipo: 'inhalar' },
  { instruccion: 'Sostenga el aire.', duracion: 3, tipo: 'mantener' },
  { instruccion: 'Boca abierta: Como empañar un vidrio.', duracion: 4, tipo: 'exhalar' },
  { instruccion: 'De nuevo, profundo por la nariz.', duracion: 4, tipo: 'inhalar' },
  { instruccion: 'Sostenga.', duracion: 3, tipo: 'mantener' },
  { instruccion: 'Expulse las secreciones.', duracion: 4, tipo: 'exhalar' },
  { instruccion: 'Sesión completada. Descanse y respire con calma.', duracion: 6, tipo: 'descanso' },
];

const PASOS_TRIFLO: PasoGuiado[] = [
  { instruccion: 'Sostenga el Triflo en posición vertical.', duracion: 6, tipo: 'preparacion' },
  { instruccion: 'Si siente mareos, descanse. No más de 10 repeticiones sin pausa.', duracion: 7, tipo: 'alerta' },
  // Rep 1
  { instruccion: 'Vacíe los pulmones fuera del dispositivo.', duracion: 5, tipo: 'exhalar' },
  { instruccion: 'Boquilla en la boca, selle bien los labios.', duracion: 3, tipo: 'preparacion' },
  { instruccion: 'Lento y constante. Bolas elevadas el mayor tiempo.', duracion: 7, tipo: 'inhalar' },
  { instruccion: 'Sostenga la inspiración.', duracion: 3, tipo: 'mantener' },
  { instruccion: 'Suelte lentamente. Respire 2 veces con normalidad.', duracion: 7, tipo: 'descanso' },
  // Rep 2
  { instruccion: 'Vacíe los pulmones fuera del aparato.', duracion: 5, tipo: 'exhalar' },
  { instruccion: 'Boquilla en la boca.', duracion: 2, tipo: 'preparacion' },
  { instruccion: 'Lento y constante. Bolas arriba.', duracion: 7, tipo: 'inhalar' },
  { instruccion: 'Sostenga.', duracion: 3, tipo: 'mantener' },
  { instruccion: 'Suelte. Respire con normalidad.', duracion: 7, tipo: 'descanso' },
  // Rep 3
  { instruccion: 'Vacíe los pulmones.', duracion: 5, tipo: 'exhalar' },
  { instruccion: 'Boquilla en la boca.', duracion: 2, tipo: 'preparacion' },
  { instruccion: 'Constancia, no fuerza. Bolas arriba.', duracion: 7, tipo: 'inhalar' },
  { instruccion: 'Sostenga.', duracion: 3, tipo: 'mantener' },
  { instruccion: 'Suelte. Respire normalmente.', duracion: 7, tipo: 'descanso' },
  // Rep 4
  { instruccion: 'Vacíe los pulmones.', duracion: 5, tipo: 'exhalar' },
  { instruccion: 'Boquilla en la boca.', duracion: 2, tipo: 'preparacion' },
  { instruccion: 'Constante. Bolas arriba el mayor tiempo.', duracion: 7, tipo: 'inhalar' },
  { instruccion: 'Sostenga.', duracion: 3, tipo: 'mantener' },
  { instruccion: 'Suelte lentamente.', duracion: 6, tipo: 'descanso' },
  // Pausa
  { instruccion: 'Pausa. Respire con normalidad.', duracion: 12, tipo: 'descanso' },
  // Rep 5
  { instruccion: 'Vacíe los pulmones.', duracion: 5, tipo: 'exhalar' },
  { instruccion: 'Boquilla en la boca.', duracion: 2, tipo: 'preparacion' },
  { instruccion: 'Lento y constante. Bolas arriba.', duracion: 7, tipo: 'inhalar' },
  ...
  { instruccion: 'Vacíe los pulmones.', duracion: 5, tipo: 'exhalar' },
  { instruccion: 'Boquilla en la boca.', duracion: 2, tipo: 'preparacion' },
  { instruccion: 'Constante. Va muy bien.', duracion: 7, tipo: 'inhalar' },
  { instruccion: 'Sostenga.', duracion: 3, tipo: 'mantener' },
  { instruccion: 'Suelte. Respire normal.', duracion: 7, tipo: 'descanso' },
  // Rep 7
  { instruccion: 'Vacíe los pulmones.', duracion: 5, tipo: 'exhalar' },
  { instruccion: 'Boquilla en la boca.', duracion: 2, tipo: 'preparacion' },
  { instruccion: 'Lento. Casi terminamos.', duracion: 7, tipo: 'inhalar' },
  { instruccion: 'Sostenga.', duracion: 3, tipo: 'mantener' },
  { instruccion: 'Suelte. Respire con normalidad.', duracion: 7, tipo: 'descanso' },
  // Rep 8
  { instruccion: 'Último. Vacíe bien los pulmones.', duracion: 5, tipo: 'exhalar' },
  { instruccion: 'Boquilla en la boca.', duracion: 2, tipo: 'preparacion' },
  { instruccion: 'Lento y constante. Bolas elevadas.', duracion: 7, tipo: 'inhalar' },
  { instruccion: 'Sostenga la inspiración.', duracion: 3, tipo: 'mantener' },
...
export const EJERCICIOS: Ejercicio[] = [
  ...
  {
    id: 'triflo',
    nombre: 'Triflo (Espirómetro de Incentivo)',
    icono: '🫧',
    categoria: 'aparatos',
    requiereAparato: 'Dispositivo Triflo',
    descripcionCorta: 'Inspirometría de incentivo: 8 repeticiones para expandir los pulmones y reclutar alveolos.',
    beneficio: 'Aumenta la capacidad inspiratoria, expande las zonas pulmonares colapsadas y mejora la saturación de oxígeno.',
    duracionMin: 8,
    dificultad: 'Fácil',
    pasos: PASOS_TRIFLO,
    advertencias: [
      'Si siente mareos, descanse de inmediato.',
      'No más de 10 repeticiones seguidas sin pausar.',
    ],
  },
  /* ── Respiratorios ── */
  {
...
export const RUTINA_SEMANAL: DiaRutina[] = [
...
export function getDiaRutinaIdx(): number {
...
export function getBloquesHoy(diaIdx: number, modoFatiga: boolean): BloqueHorario[] {
...
export function fmtTime(seg: number) {
  const m = Math.floor(seg / 60);
  const s = seg % 60;
  return m > 0 ? `${m}:${s.toString().padStart(2, '0')}` : `${s}`;
}

export const CIRCLE_CFG: Record<TipoPaso, { bg: string; ring: string; label: string }> = {
...
// Helper: elimina emojis y la palabra INHALE/EXHALE/MANTENGA al inicio
export function stripPrefixText(text: string) {
  try {
    const noEmoji = text.replace(/[\u{1F300}-\u{1F6FF}\u{2600}-\u{26FF}\u{2700}-\u{27BF}]/gu, '').trim();
    return noEmoji.replace(/^(INHALE|EXHALE|INHALAR|EXHALAR|MANTENGA|MANTENER|RETENGA|RETENER)\b[:.\s-]*/i, '').trim();
  } catch {
    return text;
  }
}

// Construye el texto a leer: label primero, luego resumen corto ajustado a los segundos disponibles.
// A rate 0.85, la voz habla ~2.5 palabras/seg. Se deja 1 seg de margen para el inicio.
export function buildSpeechText(tipo: TipoPaso, instruccion: string, duracion: number): string {
  const label = CIRCLE_CFG[tipo].label.replace(/[^\p{L}\s]/gu, '').trim();
  if (duracion <= 3) return label;
  const cleaned = stripPrefixText(instruccion);
  const maxWords = Math.max(2, Math.floor((duracion - 1) * 2.5));
  const shortened = cleaned.split(/\s+/).slice(0, maxWords).join(' ');
...
export const CATEGORIA_LABEL: Record<CategoriaEjercicio, string> = {
  respiratorio: 'Respiratorio',
  aparatos: 'Con Aparatos',
  movilidad: 'Movilidad',
};

export const CATEGORIA_COLOR: Record<CategoriaEjercicio, string> = {
...
export function BadgeCategoria({ categoria }: { categoria: CategoriaEjercicio }) {
  return (
...
export function BadgeDificultad({ dificultad }: { dificultad: Ejercicio['dificultad'] }) {
  return (
    ...
    <Card color="white" className="mb-3">
      <div className="flex items-start gap-3">
        ...
        <div className="flex-1 min-w-0">
          ...
          <h3 className="text-xl font-bold text-gray-800">{ejercicio.nombre}</h3>
          <p className="text-base text-gray-600 mt-0.5">{ejercicio.descripcionCorta}</p>
      ...
      <div className="mt-4 flex flex-col gap-2">
        <button
          ...
          className="w-full py-3 rounded-xl border-2 border-gray-200 text-base font-semibold text-gray-600 hover:bg-gray-50 transition-colors text-center"
        >
          Ver detalles
        </button>
        <button
          onClick={() => onIniciar(ejercicio)}
          className="w-full py-3 rounded-xl bg-green-600 text-white text-base font-bold hover:bg-green-700 transition-colors"
        >
...
export function ModalInstrucciones({
  ejercicio,
  onCerrar,
}: {
  ejercicio: Ejercicio;
...
export function ModalGuiado({
  ...
  useEffect(() => {
    ...
    speak(buildSpeechText(p.tipo, p.instruccion, p.duracion));
  ...
  async function iniciar() {
    ...
    setTimeout(() => speak(buildSpeechText(pasos[0].tipo, pasos[0].instruccion, pasos[0].duracion)), 300);
  }
    ...
    <div className="fixed inset-x-0 top-0 bottom-[calc(4.75rem+env(safe-area-inset-bottom,0px))] z-[60] bg-gray-50 flex flex-col overflow-hidden">
      ...
      <div className="bg-green-700 px-5 py-4 flex items-center gap-3 flex-shrink-0">
        ...
        <div className="flex-1 min-w-0">
          ...
          <h2 className="text-white text-xl font-bold leading-tight truncate">{ejercicio.nombre}</h2>
        </div>
        ...
        {showPre ? (
          ...
          <div className="flex flex-col gap-5 py-2 w-full">
            <div className="text-center">
              ...
              <h3 className="text-2xl font-bold text-gray-800 mt-2">{ejercicio.nombre}</h3>
              <p className="text-gray-500 text-base mt-1">~{ejercicio.duracionMin} min · {pasos.length} pasos</p>
            </div>
          ...
          <>
            ...
            >
              <p className="text-2xl font-extrabold uppercase tracking-widest mb-2">{cfg.label}</p>
              <p className="text-lg text-gray-800 leading-snug">{stripPrefixText(paso.instruccion)}</p>
            </div>
      ...
      <div className="bg-white w-full sm:max-w-lg sm:rounded-2xl rounded-t-2xl overflow-hidden flex flex-col max-h-full">
        ...
        <div className="overflow-y-auto flex-1 px-5 py-4 space-y-4">
          <div className="bg-green-50 rounded-xl p-3 border border-green-200">
            <p className="text-green-800 text-base font-medium">🎯 Beneficio</p>
            <p className="text-green-700 text-base mt-1">{ejercicio.beneficio}</p>
          </div>
        ...
        <div className="p-4 border-t border-gray-200 flex gap-3">
          <button onClick={onCerrar} className="flex-1 py-3 border-2 border-gray-200 rounded-xl font-semibold text-base text-gray-600 hover:bg-gray-50 transition-colors">
            Cerrar
          </button>
          <button onClick={onIniciar} className="flex-1 py-3 bg-green-600 text-white rounded-xl font-bold text-base hover:bg-green-700 transition-colors">
            {ejercicio.pasos ? '▶ Iniciar guiado' : '📖 Ver instrucciones'}
          </button>
        </div>
      </div>
